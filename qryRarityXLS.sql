...
--__________________________________________________________________________________________________________________
    ...
    polySum AS (        
        SELECT hucs.huc12rng,
               ...
               eco_l4.us_l4code,
			   CASE 
			    WHEN (eco_l4.us_l4code IS NULL) THEN 0 ELSE 1
			   END AS NNN,
    ...
    FROM  (SELECT polyMaxes.huc12rng, 
                  ...
                  polyMaxes.us_l4code ASC ) AS RowN
           FROM polyMaxes) pM  
    ...
    sppTotal AS (
        ...
        GROUP BY dist_spp_0.huc12rng, 
                 dist_spp_0.species_cd,
                 dist_spp_0.na_l2code),   -- 21,343,783 records
    ...
    sppPad1 AS (
        ...
        GROUP BY dist_spp_1.huc12rng, 
                 dist_spp_1.species_cd),   -- 2,279,004 records
    ...
    sppPad2 AS (
        ...
        GROUP BY dist_spp_2.huc12rng, 
                 dist_spp_2.species_cd),  -- 6,899,531  records
    ...
    sppPad3 AS (
        ...
        GROUP BY dist_spp_3.huc12rng, 
                 dist_spp_3.species_cd)   -- 10,697,583 records 
